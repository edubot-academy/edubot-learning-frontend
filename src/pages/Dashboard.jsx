                ...
                <div className="w-full flex justify-center mt-10">
                    <div className="overflow-hidden w-[1110px] rounded-[24px] bg-white shadow">
                        <div className="flex items-center justify-between bg-gray-50 px-6 py-4">
                            ...
                            <button className="bg-[#0EA78B] hover:bg-[#0EA78B] text-white px-4 py-2 rounded-full text-sm font-medium">
                ...
                <div className="w-full flex justify-center mt-10">
                    <div className="w-[1110px] h-[287px] rounded-[24px] bg-white shadow overflow-hidden">
                        <div className="flex items-center justify-between bg-gray-50 px-6 py-4">
                            ...
                            <button className="text-[#0EA78B] hover:text-[#0EA78B] focus:outline-none px-4 py-2 rounded-full text-[16px] font-medium">
                                Прогрессти көрүү
                            </button>
                        </div>
