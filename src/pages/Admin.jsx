                ...
                <main className="flex-1 space-y-6">
                    <div className="flex items-center justify-between flex-wrap gap-3">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Платформанын бардык секцияларына көзөмөл</p>
                        </div>
                        <button
                                    ...
                                    {categories.map((category) => (
                                        <li key={category.id} className="border p-3 rounded flex justify-between items-center">
                                            {editingCategoryId === category.id ? (
                                                <>
                                                    <input value={editingCategoryName} onChange={(e) => setEditingCategoryName(e.target.value)} className="border px-2 py-1 rounded w-full mr-2" />
                                                    <button onClick={() => handleUpdateCategory(category.id)} className="bg-green-500 text-white px-3 py-1 rounded">Сактоо</button>
                                                </>
                                            ) : (
                                                <>
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        }} className="text-blue-600">Өзгөртүү</button>
                                                        <button onClick={() => handleDeleteCategory(category.id)} className="text-red-600">Өчүрүү</button>
                                                    </div>
                                                </>
                                            )}
                                        </li>
                        ...
                        <div className="bg-white shadow rounded-2xl p-6 space-y-6">
                            <div className="flex flex-wrap gap-4 items-center">
                                <div className="flex-1 min-w-[240px]">
                                    <label className="text-sm font-semibold text-gray-600">Курс тандаңыз</label>
                                    <select
                            ...
                            <form onSubmit={handleCreatePrompt} className="grid md:grid-cols-2 gap-4 bg-gray-50 rounded-2xl p-4">
                                <div className="md:col-span-2">
                                    <label className="text-sm font-semibold text-gray-600">AI сунуш</label>
                                    <textarea
                                        value={newPromptText}
                                ...
                                <div>
                                    <label className="text-sm font-semibold text-gray-600">Тил</label>
                                    <select
                                ...
                                <div>
                                    <label className="text-sm font-semibold text-gray-600">Тартип</label>
                                    <input
                                        type="number"
                                    ...
                                    {users.map((user) => (
                                        <tr key={user.id} className="border-b">
                                            ...
                                            <td className="p-2 flex gap-2">
                                                <select value={user.role} onChange={(e) => handleRoleChange(user.id, e.target.value)} className="border px-2 py-1 rounded">
                                                    <option value="student">Студент</option>
                                                    <option value="instructor">Окутуучу</option>
                                                    <option value="sales">Сатуу</option>
                                                    <option value="admin">Admin</option>
                        ...
                        <div className="bg-white shadow rounded p-4">
                            ...
                            <ul className="space-y-3">
                                {pendingCourses.map((course) => (
                                    <li key={course.id} className="border rounded p-3 flex justify-between items-center">
                                        <div>
