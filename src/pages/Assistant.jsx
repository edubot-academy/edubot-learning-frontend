...
const AssistantDashboard = () => {
    ...
    const handleEnroll = async (student, selectedCourseId) => {
        const courseTitle = courses.find((course) => course.id === selectedCourseId)?.title ?? "курс";
    ...
    const handleUnenroll = (student, courseId) => {
        const courseTitle = courses.find((course) => course.id === courseId)?.title ?? "курс";
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-gray-700 dark:text-[#a6adba]">
                        {courses.map((course) => (
                            <div
                                key={course.id}
                                className="bg-gray-100 dark:bg-slate-700 px-3 py-2 rounded"
                            >
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center items-center mt-4 space-x-2">
                        <button
                            ...
                            className="px-3 py-1 border rounded disabled:opacity-50 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-slate-200 dark:border-slate-600"
                        >
                            ⟨ Мурунку
                        </button>
                                ...
                                <React.Fragment key={pageIndex + 1}>
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded border ${currentPage === pageIndex + 1
                                            ...
                                            : "bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-slate-200 dark:border-slate-600"
                                            }`}
                                    >
                                        {pageIndex + 1}
                                    </button>
