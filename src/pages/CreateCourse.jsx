            ...
            {step === 2 && (
                <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="rounded-xl border border-rose-300 bg-white px-3 py-2 text-sm font-medium text-rose-600 hover:bg-rose-50 dark:border-rose-700 dark:bg-[#1f1f1f] dark:text-rose-300"
                                >
                                    Ката издөө
                                </button>
                                <button
                                    onClick={addSection}
                                    className="rounded-xl bg-edubot-teal px-3 py-2 text-sm font-medium text-white hover:bg-edubot-teal/90"
                                >
                                    Бөлүм кошуу
                                </button>
                            </div>
                    ...
                    <div className="sticky bottom-4 z-10 flex justify-end">
                        <button
                            onClick={() => setStep(1)}
                            className="rounded-xl border border-slate-300 bg-white px-6 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-[#1f1f1f] dark:text-slate-200"
                        >
                            Артка
                        </button>
                        <button
                            ...
                            className="ml-3 rounded-xl bg-slate-900 px-6 py-2.5 text-sm font-medium text-white disabled:opacity-50 dark:bg-blue-950"
                        >
                            Сактоо жана улантуу
                        </button>
                    </div>
