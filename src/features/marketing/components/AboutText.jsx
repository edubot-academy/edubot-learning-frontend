        ...
        <div>
            <div className="mb-[-100px] max-w-screen bg-[#1E605E] text-white p-20 rounded-t-[30px] relative overflow-hidden">
                ...
                <p className="mb-6 text-lg pl-8">
                    <strong>EduBot Learning</strong> — бул ар бир адамга ылайыкталган онлайн билим
                    берүү платформасы...
                </p>
                ...
                <div className="mb-6 pl-8">
                    ...
                    <p className="text-lg">Интерактивдүү жана практикалык окуу аркылуу...</p>
                </div>
                ...
                <div className="pl-8">
                    <h3 className="text-2xl font-semibold mb-4">
                        Онлайн видео сабактардын артыкчылыктары
                    </h3>
                    <ul className="list-disc list-inside text-lg space-y-2">
                        <li>
                            <strong>Каалаган убакта, каалаган жерде:</strong> студенттер өз
                            графигине жараша окуй алышат.
                        </li>
                        <li>
                            <strong>Кайталап көрүү мүмкүнчүлүгү:</strong> сабакты кайра көрүп...
                        </li>
                        <li>
                            <strong>Көрүү жана угуу аркылуу үйрөнүү:</strong> визуалдык, үн жана
                            субтитрлер...
                        </li>
                        <li>
                            <strong>Кеңири масштабдуу жеткирүү:</strong> бир видео миңдеген
                            адамдарга жетиши мүмкүн.
                        </li>
                        <li>
                            <strong>Илгерилүүнү көзөмөлдөө:</strong> платформа аркылуу канча көргөнүн
                            текшерүүгө болот.
                        </li>
                        <li>
                            <strong>Талкуу жана пикир алышуу:</strong> студенттер сабак алдында же
                            соңунда суроо берип, жооп ала алышат.
                        </li>
                        <li>
                            <strong>Сапаттын туруктуулугу:</strong> бир жолу жазылган сабак ар бир
                            көрүүчү үчүн бирдей сапатта болот.
                        </li>
                    </ul>
                </div>
