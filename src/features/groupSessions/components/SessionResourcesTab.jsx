        ...
        <div className="space-y-5">
            <div className="grid gap-4 xl:grid-cols-[minmax(0,0.95fr),minmax(0,1.05fr)]">
                <DashboardInsetPanel
                    ...
                    description="Бул жерде сессияга сакталган шилтемелер гана көрсөтүлөт. Материалдарды өзгөртүү үчүн session setup'ту ачыңыз."
                    action={
                        <button
                            type="button"
                    ...
                    <div className="mt-4 space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <button
                                ...
                                className="dashboard-button-secondary disabled:opacity-60"
                            >
                                {syncingRecordings ? 'Синхрондолууда...' : 'Zoom recordings sync'}
                            </button>
                            {selectedSessionRecordingUrl && (
                                <a
                ...
                >
                    <div className="mt-4 flex flex-wrap gap-2">
                        ...
                        <button
                            ...
                            className="dashboard-button-secondary disabled:opacity-60"
                        >
                            {importingAttendance ? 'Импорттолууда...' : 'Zoom attendance импорт'}
                        </button>
                    </div>
                </DashboardInsetPanel>
            </div>
