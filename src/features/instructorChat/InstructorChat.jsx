    ...
    return (
        <div className="w-full h-full mt-8 bg-white dark:bg-[#222222] rounded-xl shadow border flex flex-col">
            ...
            <div className="px-5 py-4 border-b flex items-center gap-3">
                ...
                />
                <div>
                    <p className="font-medium text-sm">{course.instructor.fullName}</p>
                    <p className="text-[11px] text-[#0284C7]">{activeChat?.status}</p>
                </div>
            </div>
            ...
            <div ref={messagesRef} className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
                {loading && (
                    <p className="text-center text-xs text-gray-400">Билдирүү жүктөлүүдө...</p>
                )}
            ...
            <div className="mt-36  border-t px-4 py-3 flex items-center gap-3">
                <div className="relative text-[#EA580C]">
                  ...
                  ${actionsOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
                    >
                        <button className="w-9 h-9 rounded-full bg-[#FFF7ED] shadow flex items-center justify-center">
                            <CgFileDocument />
                        </button>
                        <button className="w-9 h-9 rounded-full bg-[#FFF7ED] shadow flex items-center justify-center">
                            <SlPicture />
