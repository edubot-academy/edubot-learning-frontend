    ...
    if (!course || !course.instructor) {
        return (
            <div className="w-full max-w-md h-[70vh] max-h-[500px] bg-white dark:bg-[#222222] rounded-xl shadow-xl border flex flex-col mx-auto">
                <div className="p-4 text-center text-gray-500">Курс маалыматы жүктөлө элек...</div>
            </div>
        );
    }

    return (
        <div className="w-full max-w-md h-[70vh] max-h-[500px] bg-white dark:bg-[#222222] rounded-xl shadow-xl border flex flex-col mx-auto mt-12 relative z-0">
            {/* ================= HEADER ================= */}
            <div className="px-3 py-3 sm:px-5 sm:py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between relative z-10">
            ...
            <div
                ref={messagesRef}
                className="flex-1 overflow-y-auto px-3 py-3 sm:px-5 sm:py-4 space-y-3 bg-gray-50 dark:bg-[#1A1A1A] relative z-10"
            >
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center p-4">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#FFF7ED] rounded-full flex items-center justify-center mb-3 sm:mb-4">
                            <svg
                                className="w-6 h-6 sm:w-8 sm:h-8 text-[#EA580C]"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
            ...
            {/* ================= INPUT AREA ================= */}
            <div className="border-t border-gray-200 dark:border-gray-700 px-3 py-2 sm:px-4 sm:py-3 relative z-20">
                {/* Actions panel */}
                <div className="relative mb-2 sm:mb-3" ref={actionsRef}>
                    <div
                        className={`absolute bottom-full left-0 mb-1 sm:mb-2 flex gap-1 sm:gap-2 transition-all duration-300 z-30 ${
                            actionsOpen
