...
const TopCoursesTable = ({ courses, formatNumber, formatPercent, formatCurrency, loading, t }) => (
        ...
        <div className="relative flex items-center justify-between">
            <div>
                <p className="text-sm text-edubot-muted dark:text-slate-400">
                    {t('adminStats.topCourses.eyebrow')}
                </p>
                        ...
                        <thead>
                            <tr className="text-edubot-muted dark:text-slate-400 text-left border-b border-edubot-line/70 dark:border-slate-700">
                                <th className="py-2 pr-3 font-medium">
                                    {t('adminStats.topCourses.table.course')}
                                </th>
                                <th className="py-2 pr-3 font-medium">
                                    {t('adminStats.topCourses.table.enrollments')}
                                </th>
                                <th className="py-2 pr-3 font-medium">
                                    {t('adminStats.topCourses.table.active7d')}
                                </th>
                                <th className="py-2 pr-3 font-medium">
                                    {t('adminStats.topCourses.table.completion')}
                                </th>
                                <th className="py-2 pr-3 font-medium">
                                    {t('adminStats.topCourses.table.revenue')}
                                </th>
                            </tr>
                        </thead>
