export const COURSE_DETAILS_SUPPORT_PLACEMENT = Object.freeze({
    ...
    ENROLLED: Object.freeze({
        desktop: Object.freeze(['lesson-runtime', 'sidebar-program-ai', 'below-runtime-instructor-review', 'below-runtime-discussion']),
        mobile: Object.freeze(['lesson-runtime', 'program', 'instructor', 'review', 'discussion']),
    }),
});
