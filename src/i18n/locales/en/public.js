export const publicResources = {
    public: {
        ...
        externalResources: {
            pageTitle: 'Free World-Class Courses',
            pageSubtitle: '{{count}} free courses from Harvard, Google, freeCodeCamp and other global platforms. Study with EduBot\'s guidance.',
            emptyCategory: 'No courses in this category yet.',
            viewAll: 'View all',
            homeSectionTitle: 'Free World-Class Courses',
            homeSectionSubtitle: 'Courses selected from Harvard, Google and other world-class universities — guided by EduBot.',
            learnWithGuidance: 'Study with Guidance',
            ...
            audit: 'Audit',
            auditFreeLabel: 'Free',
            auditFreeCta: 'Audit Free →',
            getCertificateCta: 'Get Certificate ({{cost}})',
            signUpCta: 'Sign Up →',
            officialSiteCta: 'Go to Official Site',
            officialSiteNote: 'You will be redirected to an external platform. Registration may be required.',
            whatYouWillLearn: 'What you will learn',
            whoIsItFor: 'Who is it for',
            whyRecommended: 'Why we recommend it',
            studyPlan: 'Study Plan',
            difficultyNotes: 'Notes',
            authPromptTitle: 'Study with Kyrgyz guidance',
            authPromptBody: 'Find Kyrgyz-language courses and live group sessions related to this course on the EduBot platform.',
            register: 'Sign up',
            disclaimerWithProvider: 'This course is provided by "{{provider}}" and is hosted on an external platform. EduBot Learning does not guarantee permanent access to this course. Please verify course availability before visiting the official site.',
            disclaimerWithoutProvider: 'This course is hosted on an external platform. EduBot Learning does not guarantee permanent access to this course. Please verify course availability before visiting the official site.',
            coursesSectionTitle: 'Additional Free Resources',
            coursesSectionSubtitle: 'World-class free courses selected for Kyrgyz students.',
            courseDetailSectionSubtitle: 'Free external resources related to this course.',
            courseDetailCta: 'Open EduBot Guide',
            save: 'Save',
            saved: 'Saved',
            ...
            saveToast: '"{{title}}" added to your learning plan ✅',
            startToast: '"{{title}}" started 🚀',
            completeToast: '"{{title}}" completed 🎉',
            topicAll: 'All',
            aiPlanCta: 'Get my AI study plan',
            aiPlanHide: 'Hide',
            aiPlanLoading: 'Generating your personalized plan...',
            aiPlanTitle: 'AI Study Recommendation',
            aiPlanError: 'Something went wrong. Please try again.',
            aiPlanSave: 'Save plan',
            aiPlanSaved: 'Plan saved',
            aiConceptSave: 'Save explanation',
            aiConceptSaved: 'Explanation saved',
            aiTasksSave: 'Save tasks',
            aiTasksSaved: 'Tasks saved',
            aiConceptCta: 'Explain a concept',
            aiConceptPlaceholder: 'e.g. recursion, pointer, API...',
            aiConceptGenerate: 'Explain',
            aiConceptLoading: 'Explaining...',
            aiConceptTitle: 'AI Explanation',
            aiConceptError: 'Could not explain. Please try again.',
            aiConceptEmpty: 'Enter a concept above and press Explain.',
            aiTasksCta: 'Generate practice tasks',
            aiTasksLoading: 'Generating tasks...',
            aiTasksTitle: 'Practice Tasks',
            aiTasksHide: 'Hide',
            aiTasksError: 'Could not generate tasks. Please try again.',
            relatedLessonsTitle: 'Related EduBot Lessons',
            relatedLessonsBody: 'Looking for structured Kyrgyz-language lessons with mentorship? Check these EduBot courses:',
            relatedLessonsBtn: 'View EduBot course',
            certSectionTitle: 'Certificate',
            certUploadCta: 'Upload your certificate',
            certUploadHint: 'PDF, PNG or JPEG · up to 5 MB',
            certUploading: 'Uploading...',
            certUploaded: 'Certificate saved',
            certView: 'View certificate',
            certReplace: 'Replace certificate',
            certUploadError: 'Upload failed. Please try again.',
            myPlan: 'My free resources',
            myPlanEmpty: 'No saved free resources yet. Browse resources and add them to your learning plan.',
            myPlanBrowse: 'Browse resources',
            statusSaved: 'Saved',
            statusStarted: 'In progress',
            statusCompleted: 'Completed',
            yourProgress: 'Your Progress',
            weeksProgress: '{{done}} of {{total}} weeks done',
            continueOnDashboard: 'Continue on Dashboard →',
            categories: {
                all: 'All',
