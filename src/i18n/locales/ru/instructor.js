    ...
    instructorDashboard: {
        ...
        courseBuilder: {
            ...
            quiz: {
                ...
                richTextHint: "Выделите текст для форматирования: жирный, курсив или код",
                explanation: {
                    label: "Объяснение",
                    hint: "(показывается студенту после ответа)",
                    placeholder: "Объясните, почему правильный ответ верен…",
                },
            },
            articleEditor: {
                ...
                keyboardHint: "Совет: Ctrl/Cmd + B — жирный, Ctrl/Cmd + I — курсив. Вставка из Google Docs, Word или веб-страниц — форматирование сохраняется автоматически.",
                toolbar: {
                    bold: "Жирный",
                    italic: "Курсив",
