export const shared = {
    ...
    ai: {
        ...
        copyWorksheetText: "Скопировать текст рабочего листа",
        courseDraft: "AI-черновик курса",
        courseDraftAccepted: "AI-черновик курса скопирован в конструктор.",
        courseDraftFailed: "Не удалось создать AI-черновик курса.",
        courseDraftHelp: "Создайте редактируемый план курса. Ничего не сохраняется, пока вы не сохраните курс и программу.",
        courseDraftReady: "AI-черновик курса готов.",
        courseDraftRejected: "AI-черновик курса отменен.",
        courseDraftTopicRequired: "Добавьте название курса перед запросом AI-черновика.",
        feedbackDraft: "AI-черновик обратной связи",
        feedbackDraftAccepted: "AI-черновик скопирован в проверку.",
        feedbackDraftActionFailed: "Не удалось обновить статус AI-черновика.",
        feedbackDraftFailed: "Не удалось создать AI-черновик обратной связи.",
        feedbackDraftReady: "AI-черновик обратной связи готов.",
        feedbackDraftRejected: "AI-черновик отменен.",
        generating: "Генерация...",
        openGenerator: "Открыть AI-генератор",
        openPreview: "Открыть AI-превью",
        panelEyebrow: "AI-черновик",
        homeworkDraft: "AI-черновик домашнего задания",
        homeworkDraftAccepted: "AI-черновик скопирован в форму.",
        homeworkDraftFailed: "Не удалось создать AI-черновик домашнего задания.",
        homeworkDraftReady: "AI-черновик домашнего задания готов.",
        homeworkDraftRejected: "AI-черновик домашнего задания отменен.",
        manualMode: "Вручную",
        aiDraftMode: "AI-черновик",
        regenerateDraft: "Создать заново",
        useInManualForm: "Перенести в форму",
        homeworkBrief: {
            collapsedHelp: "Откройте AI-бриф только если нужен черновик с подсказками. Уже введенное название используется как тема.",
            openBrief: "Сгенерировать с AI",
            hideBrief: "Скрыть AI-бриф",
            topic: "Что должно проверить домашнее задание?",
            topicPlaceholder: "Например: практика линейных уравнений через задачи из жизни",
            instructions: "Инструкции",
            instructionsPlaceholder: "Например: создайте 5 заданий, добавьте 2 текстовые задачи и один сложный вопрос",
            difficulty: "Сложность",
            difficultyAuto: "Использовать уровень курса",
            difficultyBeginner: "Начальный",
            difficultyIntermediate: "Средний",
            difficultyAdvanced: "Продвинутый",
            maxScore: "Максимальный балл",
            maxScorePlaceholder: "Например: 100",
            includeRubric: "Добавить критерии оценки",
            help: "Опишите цель задания перед генерацией, чтобы AI использовал правильный контекст и было меньше повторных запросов.",
            topicIssues: {
                required: "Введите тему или цель перед генерацией.",
                tooShort: "Сделайте тему более конкретной.",
                meaningless: "Укажите осмысленную тему домашнего задания.",
                generic: "Добавьте навык или понятие, которое должны отработать студенты."
            }
        },
        lessonDraftRequiresSavedLesson: "Сохраните урок перед запросом AI-черновика.",
        lessonKitDraft: "AI-черновик набора урока",
        lessonKitDraftAccepted: "AI-набор урока скопирован в редактор урока.",
        lessonKitDraftFailed: "Не удалось создать AI-черновик набора урока.",
        lessonKitDraftHelp: "Создайте редактируемый материал статьи из краткого описания, целей, примеров и идеи домашнего задания.",
        lessonKitDraftInvalid: "AI-черновик набора урока не содержит подходящего материала.",
        lessonKitDraftReady: "AI-черновик набора урока готов.",
        lessonKitDraftRejected: "AI-черновик набора урока отменен.",
        lessonKitExamples: "Примеры",
        lessonKitHomeworkIdea: "Идея домашнего задания",
        lessonKitObjectives: "Цели",
        lessonKitVocabulary: "Словарь",
        lessonCount: "{{count}} уроков",
        questionCount: "{{count}} вопросов",
        quizDraft: "AI-черновик теста",
        quizDraftCorrect: "Правильно:",
        quizDraftAccepted: "AI-черновик теста скопирован в редактор.",
        quizDraftFailed: "Не удалось создать AI-черновик теста.",
        quizDraftHelp: "Создайте редактируемые вопросы теста. Ничего не сохраняется, пока вы не сохраните программу.",
        quizDraftFlow: {
            createsLabel: "Создает",
            creates: "Название теста, описание, вопросы, варианты и правильные ответы.",
            appliesLabel: "Попадает в",
            applies: "Этот редактор активности после нажатия Использовать черновик.",
            nextLabel: "Дальше",
            next: "Проверьте каждый вопрос, затем сохраните активность."
        },
        quizDraftInvalid: "AI-черновик теста не содержит подходящих вопросов.",
        quizDraftReady: "AI-черновик теста готов.",
        quizDraftRejected: "AI-черновик теста отменен.",
        quizBrief: {
            topicPlaceholder: "Тема или навык для проверки",
            questionCount: "Количество вопросов",
            difficultyAuto: "Использовать уровень курса",
            modeMixed: "Смешанные типы вопросов",
            includeExplanations: "Добавить объяснения"
        },
        requestId: "ID запроса: {{requestId}}",
        rubric: "Критерии оценки",
        suggestFeedback: "Предложить отзыв с AI",
        suggestCourse: "Предложить курс с AI",
        suggestHomework: "Предложить домашнее задание с AI",
        suggestLessonKit: "Предложить набор урока с AI",
        suggestQuiz: "Предложить тест с AI",
        suggestWorksheet: "Создать текст рабочего листа с AI",
        worksheetDraft: "AI-черновик текста рабочего листа",
        worksheetDraftAccepted: "AI-черновик рабочего листа отмечен как использованный.",
        worksheetDraftPreview: "Редактируемый текст рабочего листа",
        worksheetDraftCopied: "AI-черновик рабочего листа скопирован в буфер обмена.",
        worksheetDraftFailed: "Не удалось создать AI-черновик рабочего листа.",
        worksheetDraftStatusUpdateFailed: "Материал сохранен, но статус AI-черновика не удалось обновить.",
        worksheetDraftFlow: {
            createsLabel: "Создает",
            creates: "Текст раздатки с инструкциями, разделами, заданиями и ответами.",
            appliesLabel: "Попадает в",
            applies: "Сначала в редактируемый предпросмотр, чтобы вы проверили результат.",
            nextLabel: "Дальше",
            next: "Отредактируйте предпросмотр, затем сохраните как материал PDF или DOCX."
        },
        worksheetDraftHelp: "Создайте редактируемый текст рабочего листа, проверьте его, затем сохраните как материал PDF или DOCX.",
        worksheetDraftNextStep: "Проверьте и отредактируйте текст перед сохранением как материал для студентов.",
        worksheetMaterialCreateFailed: "Не удалось создать файл материала.",
        createMaterialFile: "Создать файл материала",
        createPdfMaterial: "Сохранить PDF",
        createDocxMaterial: "Сохранить DOCX",
        worksheetBrief: {
            topicPlaceholder: "Тема или навык для практики",
            formatPractice: "Практический лист",
            formatHandout: "Раздатка для занятия",
            formatDiscussion: "План обсуждения",
            formatRecap: "Конспект-повторение",
            activityCount: "Количество активностей",
            includeAnswerKey: "Добавить ответы"
        },
        useDraft: "Использовать черновик"
    },
    media: {
        video: {
