export const dashboard = {
    ...
    assistantCompanyState: {
        ...
        noCompany: {
            ...
            description: "Ваш аккаунт ассистента пока не подключен к тенанту. Попросите администратора платформы или тенанта добавить вас перед работой со студентами и курсами.",
            emptyTitle: "Нужен доступ к тенанту",
            emptySubtitle: "Инструменты ассистента привязаны к тенанту, поэтому действия со студентами, курсами и посещаемостью остаются в правильной панели компании."
        },
        select: {
            title: "Выберите панель тенанта",
            description: "Вы подключены к нескольким тенантам. Выберите контекст компании перед просмотром студентов, посещаемости или записей.",
