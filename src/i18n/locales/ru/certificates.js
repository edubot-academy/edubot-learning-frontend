        ...
        page: {
            ...
            template: {
                ...
                signer: {
                    ...
                    studentNamePlaceholder: "Выберите одного студента, чтобы изменить отображаемое имя",
                    studentNameHelp: "Это значение применяется только к выбранному студенту при выдаче или подтверждении сертификата.",
                    studentNameSelectHelp: "Сначала выберите одного студента выше, чтобы просмотреть или изменить имя на сертификате.",
            ...
            students: {
                ...
                eligibilityOverrideLabel: "Разрешить ручной обход.",
                eligibilityOverrideHelp: "Включите это, чтобы выдать сертификат, даже если текущие требования допуска еще не выполнены.",
                eligibility: {
