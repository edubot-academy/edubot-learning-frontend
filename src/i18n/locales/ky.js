export const ky = {
    ...
    dashboardHeader: {
        ...
        chips: {
            ...
            liveShell: 'Жандуу dashboard shell',
        },
    },
    ...
    attendance: {
        ...
        admin: {
            overrideOpen: 'Admin override режими ачык',
            readOnly: 'Admin режиминде окуу гана',
        ...
        empty: {
            ...
            selectCourseDescription: 'Катышууну көрүү үчүн адегенде offline же live курс тандаңыз.',
    ...
    instructorDashboard: {
        ...
        courseBuilder: {
            ...
            assets: {
                ...
                previewVideo: 'Превью видеосун белгилөө',
            ...
            curriculum: {
                ...
                title: 'Окуу мазмуну',
                validationTitle: 'Preview кадамына өтүүдөн мурун оңдоого тийиш болгон сабактар',
            ...
            preview: {
                ...
                fixWarningsTitle: 'Алгач превьюдагы каталарды оңдоңуз',
                stats: {
                    sections: 'Бөлүмдөр',
                    lessons: 'Сабактар',
                    totalTime: 'Жалпы убакыт',
                    previewLessons: 'Превью сабактар',
                },
                fallbacks: {
                ...
                warnings: {
                    ...
                    noPreviewLessons: 'Бир да превью сабак белгиленген эмес (видеолор үчүн сунушталат).',
