export const en = {
    ...
    assistantCompanyState: {
        ...
        noCompany: {
            ...
            description:
                'Your assistant account is not connected to a tenant yet. Ask a platform admin or tenant admin to add you before working with students and courses.',
            emptyTitle: 'Tenant access is required',
            emptySubtitle:
                'Assistant tools are tenant-scoped so student, course, and attendance actions stay inside the right company dashboard.',
        },
        select: {
            title: 'Choose a tenant dashboard',
            description:
                'You are connected to multiple tenants. Select the company context before reviewing students, attendance, or enrollments.',
    ...
    instructorDashboard: {
        ...
        courseBuilder: {
            ...
            articleEditor: {
                ...
                keyboardHint:
                    'Tip: Ctrl/Cmd + B for bold, Ctrl/Cmd + I for italic. Use the </> button or the ` key for code.',
                toolbar: {
                    bold: 'Bold',
                    italic: 'Italic',
                    underline: 'Underline',
            ...
            previewStep: {
                ...
                createDescription:
                    'The local draft is stored only in this browser. Use the actions below to save it to the server and send it for review.',
                editDescription:
                    'Make sure changes are saved before sending for approval. Updated content should affect students only after the review is complete.',
                unsavedWarning:
                    'There are unsaved changes, so sending for approval is disabled for now.',
                actions: {
        ...
        groupsSection: {
            header: {
                ...
                activeDescription:
                    'For offline and online live courses, the group is the academic container: enrollments attach to the group, and sessions read from that group.',
            },
            noDelivery: {
                ...
                pendingCount:
                    '{{count}} delivery course is not ready for groups yet. A course must be approved and published before groups can be created.',
            },
            actions: {
                createCourse: 'Create course',
            ...
            empty: {
                ...
                selectCourseTitle: 'Select a course',
                noGroupsSubtitle:
                    'After a group is created, student enrollment, sessions, and attendance start from this container.',
    ...
    company: {
        ...
        adminCompanies: {
            ...
            createModal: {
                title: 'Create tenant',
                subtitle:
                    'Create the LMS tenant first. Owner and member cleanup is handled from tenant detail.',
        ...
        leaderboard: {
            ...
            challenge: {
                ...
                keywords: {
                    ...
                    continue: ['streak', 'tomorrow', 'continue'],
                },
                badges: {
                    skill: 'Skill',
                    continue: 'Streak',
