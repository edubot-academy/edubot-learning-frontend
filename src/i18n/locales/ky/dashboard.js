export const dashboard = {
    ...
    assistantDashboard: {
        ...
        overview: {
            ...
            workflow: {
                title: "Иш кезеги",
                description: "Негизги колдонмодогу студент жана курс милдеттери."
            },
            scope: {
                label: "Чөйрө",
                title: "Негизги колдонмо иш мейкиндиги",
                description: "Тенанттын жеке курстары жана компания дайындары бул жерде эмес, тенант панелдеринде иштетилет."
            },
            signal: {
                label: "Чечим сигналы",
