    ...
    groupSessions: {
        ...
        homeworkModal: {
            ...
            fields: {
                ...
                maxScore: "Максималдык балл (ыктыярчы)"
            },
            placeholders: {
            ...
            maxScoreHelp: "Бул тапшырма боюнча максималдык балл. Баалабаган тапшырмалар үчүн бош калтырыңыз.",
            validation: {
        ...
        homeworkTab: {
            ...
            reviewModal: {
                ...
                scoreLabel: "Балл (ыктыярчы)",
                scoreMax: "{{max}} дан",
                scorePlaceholder: "Балл киргизиңиз",
