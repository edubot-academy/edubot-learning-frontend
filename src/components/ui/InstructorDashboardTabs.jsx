...
const InstructorDashboardTabs = ({ items, activeId, onSelect }) => {
        ...
        <div className="md:hidden">
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-[60]">
                ...
                {showMore && hiddenItems.length > 0 && (
                    <div className="fixed bottom-20 left-4 right-4 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 max-h-[60vh] overflow-y-auto">
                        <div className="p-4">
...
InstructorDashboardTabs.propTypes = {
