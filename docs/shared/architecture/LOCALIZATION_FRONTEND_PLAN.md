...
- Instructor delivery/group-management localization has started with course/student data-load messages, instructor profile feedback, the instructor overview dashboard/mobile summary, delivery course create/edit, offering management dashboard, offering create/edit, course group form, group enrollment, offering enrollment, session generation, and AI workspace dashboard surfaces, including headings, delivery-mode cards, filters, metrics, cards, fields, student picker, delivery notices, weekly schedule controls, statuses, preview states, setup steps, active-language dates, and actions.
...
- Admin/internal dashboard localization is incomplete. Remaining high-volume gaps include instructor dashboard sections/modals beyond the group form, attendance, group-session workspace, course builder validation/curriculum flows, ratings/comments, and internal leaderboard.
