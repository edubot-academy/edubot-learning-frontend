...
8. Attendance, certificates, and reporting. Admin certificate toasts and public certificate download/verification pages are partly done; attendance and reporting surfaces still need coverage.
...
- Admin/internal dashboard localization is incomplete. Remaining high-volume gaps include instructor dashboard sections/modals beyond the completed overview/analytics/homework-queue/group/offering/session-setup/homework/activity/resource/notes/engagement/leaderboard surfaces, attendance, and course builder validation/curriculum flows.
