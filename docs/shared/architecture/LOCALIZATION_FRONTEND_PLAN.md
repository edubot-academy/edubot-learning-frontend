...
- Instructor delivery/group-management localization has started with course/student data-load messages, instructor profile feedback, the instructor overview dashboard/mobile summary, instructor analytics workspace, delivery course create/edit, offering management dashboard, offering create/edit, course group form, group enrollment, offering enrollment, session generation, group-session setup/homework/activity/resource workflows, group-session notes/engagement surfaces, localized activity/resource workspace toasts, and AI workspace dashboard surfaces, including headings, delivery-mode cards, filters, metrics, cards, fields, student picker, delivery notices, weekly schedule controls, statuses, preview states, setup steps, active-language dates, recommendations, charts, and actions.
...
- Error handling still needs broader adoption in feature-specific toast paths, especially remaining instructor, student chat/task/resource, attendance, and course-builder flows.
...
7. Course/player flows beyond public course details. Started for shared video fallback states and instructor group-management modals; course builder and review/comment flows still need coverage.
8. Attendance, certificates, and reporting. Admin certificate toasts are partly done; attendance and reporting surfaces still need coverage.
...
- Admin/internal dashboard localization is incomplete. Remaining high-volume gaps include instructor dashboard sections/modals beyond the completed overview/analytics/group/offering/session-setup/homework/activity/resource/notes/engagement surfaces, attendance, course builder validation/curriculum flows, ratings/comments, and internal leaderboard.
