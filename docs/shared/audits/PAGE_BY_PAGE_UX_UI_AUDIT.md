...
| ID        | Severity | Area                  | Issue                                                                                                                                         | Task                                                                                                              | Owner | Status      |
| --------- | -------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----- | ----------- |
| EMBED-001 | P1       | Architecture          | Several embedded operational pages are acting as large controllers with data fetching, business rules, filters, and UI state all in one file  | Break embedded workspaces into smaller domain hooks/controllers and keep page shells thin                         | Codex | In progress |
